...
class BayaranRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bank_account_id' => ['nullable', 'required_unless:cara_bayar,PWR', 'integer', 'exists:bank_account,id'],
            'pwr_coa_id'      => ['nullable', 'required_if:cara_bayar,PWR', 'integer', 'exists:coa,id'],
